...
"[project]/src/contexts/auth-provider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const [userWithdrawals, setUserWithdrawals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [allWithdrawals, setAllWithdrawals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[handleUser]": async (firebaseUser)=>{
            if (firebaseUser) {
                ...
                if (userSnap.exists()) {
                    ...
                    // This case handles user creation
                    const newUserData = {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userRef, newUserData);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'withdrawals'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('userId', '==', user.uid));
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "AuthProvider.useEffect.unsubscribe": (querySnapshot)=>{
                    const withdrawals = querySnapshot.docs.map({
                        "AuthProvider.useEffect.unsubscribe.withdrawals": (doc)=>({
                                id: doc.id,
                                ...doc.data(),
                                createdAt: doc.data().createdAt.toDate()
                            })
                    }["AuthProvider.useEffect.unsubscribe.withdrawals"]);
                    // Sort withdrawals by date on the client side
                    withdrawals.sort({
                        "AuthProvider.useEffect.unsubscribe": (a, b)=>b.createdAt.getTime() - a.createdAt.getTime()
                    }["AuthProvider.useEffect.unsubscribe"]);
                ...
                "AuthProvider.useEffect.unsubscribe": (error)=>{
                    ...
                    toast({
                        ...
                        description: 'Could not load withdrawal history. Please try again later.'
                    });
                }
            }["AuthProvider.useEffect.unsubscribe"]);
            return ({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const adminEmail = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ADMIN_EMAIL || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.ADMIN_EMAIL;
                ...
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                    ...
                    "AuthProvider.useEffect.unsubscribe": (error)=>{
                        ...
                        if (error.code === 'failed-precondition') {
                            console.error("Firestore index missing for admin query:", error.message);
                            toast({
                                variant: 'destructive',
                                title: 'Admin Error: Index Required',
                                description: 'An index is required for sorting all withdrawals. Please create it in the Firebase console.'
                            });
                        }
                    }
                }["AuthProvider.useEffect.unsubscribe"]);
    ...
    const updateBalance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateBalance]": async (amount)=>{
            if (!user) return;
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(userRef, {
                balance: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["increment"])(amount)
            });
            setUserData({
                "AuthProvider.useCallback[updateBalance]": (prev)=>prev ? {
                        ...prev,
                        balance: prev.balance + amount
                    } : null
            }["AuthProvider.useCallback[updateBalance]"]);
        }
    }["AuthProvider.useCallback[updateBalance]"], [
        user
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            }["AuthProvider.useEffect.interval"], 60000); // 60 seconds
            return ({
    ...
    const requestWithdrawal = async (amount, gamepassLink)=>{
        if (!user || !userData || userData.balance < amount) {
            toast({
                variant: 'destructive',
                title: 'Withdrawal Error',
                description: 'Insufficient balance or not signed in.'
            });
            return false;
        }
        try {
            const withdrawalRequest = {
                ...
                gamepassLink,
                status: 'pending',
                createdAt: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"](Math.floor(Date.now() / 1000), 0)
            };
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'withdrawals'), withdrawalRequest);
    ...
    const updateWithdrawalStatus = async (id, status)=>{
        const withdrawalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'withdrawals', id);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(withdrawalRef, {
                status
            });
            toast({
                title: 'Success',
            ...
            if (status === 'rejected') {
                const withdrawalSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(withdrawalRef);
                if (withdrawalSnap.exists()) {
                    const { userId, amount } = withdrawalSnap.data();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/src/contexts/auth-provider.tsx",
        lineNumber: 257,
        columnNumber: 10
    }, this);
}
_s(AuthProvider, "KgpjVQseQIvgvbj/ii2sbQ4sh+Q=", false, function() {
    return [
...
//# sourceMappingURL=src_3f92daa7._.js.map